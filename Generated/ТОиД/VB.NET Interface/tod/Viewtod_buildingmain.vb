...
Public Class viewtod_buildingmain
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.gv.TabIndex = 0
        '
        'viewtod_buildingmain
        '
        Me.Controls.Add (Me.gv)
        Me.name = "viewtod_buildingmain"
...
''' </remarks>
    Public Sub Init()
        ...
        Dim dt As DataTable
        dt = item.tod_building.GetDataTable()
        dt.TableName = "tod_building"

        ts = New DataGridTableStyle
        ts.MappingName = "tod_building"
        ts.ReadOnly = True
...
''' </remarks>
    Private Sub gv_OnEdit(ByRef OK As Boolean, ByVal ID As System.Guid) Handles gv.OnGridEdit
        Dim ed As tod.tod.tod_building
        ed = item.FindRowObject("tod_building", ID)
...
''' </remarks>
    ...
    Exit Sub
        ...
        If ID.Equals(System.guid.Empty) Then
              ed = Item.tod_building.Add
          Else
              ed = Item.tod_building.Add(ID.ToString())
          End If
        Dim gui As Doc_GUIBase
        Dim dt As DataTable
        gui = GuiManager.GetTypeGUI(ed.Application.TypeName)
