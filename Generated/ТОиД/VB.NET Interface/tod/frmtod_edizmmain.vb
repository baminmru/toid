...
''' <summary>
'''Форма редактирования раздела Единицы измерения режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtod_edizmmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittod_edizm As todGUI.edittod_edizmmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittod_edizm = New todGUI.Edittod_edizmmain
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tod.tod.tod_edizm)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittod_edizm.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittod_edizm_Changed() Handles Edittod_edizm.Changed
