...
''' <summary>
'''Форма редактирования раздела Группы узлов режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtod_systemmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittod_system As todGUI.edittod_systemmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittod_system = New todGUI.Edittod_systemmain
        ...
        'Edittod_system
        '
        Me.Edittod_system.AutoScroll = True
        Me.Edittod_system.Location = New System.Drawing.Point(8, 8)
        Me.Edittod_system.name = "Edittod_system"
        Me.Edittod_system.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittod_system.TabIndex = 20
        Me.Edittod_system.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtod_system
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittod_system)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtod_system"
        Me.Text = "Группы узлов"
...
#End Region
    Public Item As tod.tod.tod_system
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tod.tod.tod_system)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittod_system.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittod_system_Changed() Handles Edittod_system.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittod_system.GetMaxX() + 10, Edittod_system.GetMaxY() + 35)
