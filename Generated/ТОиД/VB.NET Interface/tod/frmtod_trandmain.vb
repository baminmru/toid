...
''' <summary>
'''Форма редактирования раздела Тип тренда режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtod_trandmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittod_trand As todGUI.edittod_trandmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittod_trand = New todGUI.Edittod_trandmain
        ...
        'Edittod_trand
        '
        Me.Edittod_trand.AutoScroll = True
        Me.Edittod_trand.Location = New System.Drawing.Point(8, 8)
        Me.Edittod_trand.name = "Edittod_trand"
        Me.Edittod_trand.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittod_trand.TabIndex = 20
        Me.Edittod_trand.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtod_trand
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittod_trand)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtod_trand"
        Me.Text = "Тип тренда"
...
#End Region
    Public Item As tod.tod.tod_trand
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tod.tod.tod_trand)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittod_trand.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittod_trand_Changed() Handles Edittod_trand.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittod_trand.GetMaxX() + 10, Edittod_trand.GetMaxY() + 35)
