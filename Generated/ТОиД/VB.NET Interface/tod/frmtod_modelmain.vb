...
''' <summary>
'''Форма редактирования раздела Модели станков режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtod_modelmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittod_model As todGUI.edittod_modelmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittod_model = New todGUI.Edittod_modelmain
        ...
        'Edittod_model
        '
        Me.Edittod_model.AutoScroll = True
        Me.Edittod_model.Location = New System.Drawing.Point(8, 8)
        Me.Edittod_model.name = "Edittod_model"
        Me.Edittod_model.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittod_model.TabIndex = 20
        Me.Edittod_model.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtod_model
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittod_model)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtod_model"
        Me.Text = "Модели станков"
...
#End Region
    Public Item As tod.tod.tod_model
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tod.tod.tod_model)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittod_model.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittod_model_Changed() Handles Edittod_model.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittod_model.GetMaxX() + 10, Edittod_model.GetMaxY() + 35)
