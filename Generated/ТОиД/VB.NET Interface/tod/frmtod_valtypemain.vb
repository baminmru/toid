...
''' <summary>
'''Форма редактирования раздела Тип измерения режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtod_valtypemain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittod_valtype As todGUI.edittod_valtypemain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittod_valtype = New todGUI.Edittod_valtypemain
        ...
        'Edittod_valtype
        '
        Me.Edittod_valtype.AutoScroll = True
        Me.Edittod_valtype.Location = New System.Drawing.Point(8, 8)
        Me.Edittod_valtype.name = "Edittod_valtype"
        Me.Edittod_valtype.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittod_valtype.TabIndex = 20
        Me.Edittod_valtype.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtod_valtype
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittod_valtype)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtod_valtype"
        Me.Text = "Тип измерения"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tod.tod.tod_valtype)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittod_valtype.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittod_valtype_Changed() Handles Edittod_valtype.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If Edittod_valtype.IsOK() Then
          Edittod_valtype.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittod_valtype.GetMaxX() + 10, Edittod_valtype.GetMaxY() + 35)
