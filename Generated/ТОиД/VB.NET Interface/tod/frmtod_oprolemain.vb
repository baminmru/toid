...
''' <summary>
'''Форма редактирования раздела Роль режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtod_oprolemain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittod_oprole As todGUI.edittod_oprolemain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittod_oprole = New todGUI.Edittod_oprolemain
        ...
        'Edittod_oprole
        '
        Me.Edittod_oprole.AutoScroll = True
        Me.Edittod_oprole.Location = New System.Drawing.Point(8, 8)
        Me.Edittod_oprole.name = "Edittod_oprole"
        Me.Edittod_oprole.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittod_oprole.TabIndex = 20
        Me.Edittod_oprole.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtod_oprole
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittod_oprole)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtod_oprole"
        Me.Text = "Роль"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tod.tod.tod_oprole)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittod_oprole.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittod_oprole_Changed() Handles Edittod_oprole.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittod_oprole.GetMaxX() + 10, Edittod_oprole.GetMaxY() + 35)
