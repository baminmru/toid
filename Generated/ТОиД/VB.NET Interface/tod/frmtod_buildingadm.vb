...
''' <summary>
'''Форма редактирования раздела Цех режим:adm
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtod_buildingadm
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittod_building As todGUI.edittod_buildingadm
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittod_building = New todGUI.Edittod_buildingadm
        ...
        'Edittod_building
        '
        Me.Edittod_building.AutoScroll = True
        Me.Edittod_building.Location = New System.Drawing.Point(8, 8)
        Me.Edittod_building.name = "Edittod_building"
        Me.Edittod_building.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittod_building.TabIndex = 20
        Me.Edittod_building.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtod_building
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittod_building)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtod_building"
        Me.Text = "Цех"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tod.tod.tod_building)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittod_building.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittod_building_Changed() Handles Edittod_building.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If Edittod_building.IsOK() Then
          Edittod_building.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittod_building.GetMaxX() + 10, Edittod_building.GetMaxY() + 35)
