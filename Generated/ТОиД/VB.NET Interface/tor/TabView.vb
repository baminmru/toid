...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Viewtor_info As torGUI.viewtor_info
   
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.tab = New System.Windows.Forms.TabControl
   TabPage1 = New System.Windows.Forms.TabPage
   Viewtor_info = new viewtor_info
   ...
   Me.TabPage1.SuspendLayout()
        ...
        'TabPage1
        '
        Me.TabPage1.Controls.Add (Me.Viewtor_info)
        Me.TabPage1.Location = New System.Drawing.Point(-10000, -10000)
        Me.TabPage1.name = "TabPage1"
        Me.TabPage1.Text = "Записи о рабочих станциях"
        ...
        'Viewtor_info
        '
        Me.Viewtor_info.Dock = System.Windows.Forms.DockStyle.Fill
        Me.Viewtor_info.Location = New System.Drawing.Point(0, 0)
        Me.Viewtor_info.name = "Viewtor_info"
        Me.Viewtor_info.Size = New System.Drawing.Size(504, 352)
        Me.Viewtor_info.TabIndex = 0
...
''' </remarks>
    Public Sub Attach(ByVal docItem As LATIR2.Document.Doc_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, byval DocReadOnly as boolean  ) Implements LATIR2GUIManager.IViewPanel.Attach
        ...
        GuiManager = gm
        Viewtor_info.Attach(item, GuiManager,DocReadOnly)
    End Sub
...
''' </remarks>
    ...
    Dim ok As Boolean
    ok = True
        ok = ok And Viewtor_info.Save(Sielent, NoError)
       Return ok
    End function
...
''' </remarks>
    ...
    ok = False
        ok = ok or Viewtor_info.IsChanged()
       Return ok
    End function
