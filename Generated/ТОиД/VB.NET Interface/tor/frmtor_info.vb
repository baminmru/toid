...
''' <summary>
'''Форма редактирования раздела Записи о рабочих станциях режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtor_info
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittor_info As torGUI.edittor_info
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittor_info = New torGUI.Edittor_info
        ...
        'Edittor_info
        '
        Me.Edittor_info.AutoScroll = True
        Me.Edittor_info.Location = New System.Drawing.Point(8, 8)
        Me.Edittor_info.name = "Edittor_info"
        Me.Edittor_info.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittor_info.TabIndex = 20
        Me.Edittor_info.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtor_info
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittor_info)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtor_info"
        Me.Text = "Записи о рабочих станциях"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tor.tor.tor_info)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittor_info.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittor_info_Changed() Handles Edittor_info.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittor_info.GetMaxX() + 10, Edittor_info.GetMaxY() + 35)
