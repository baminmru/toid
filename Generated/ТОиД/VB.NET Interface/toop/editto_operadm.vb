...
''' <summary>
'''Контрол редактирования раздела Оператор режим:adm
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class editto_operadm
...
Dim OK as boolean 
        If GuiManager.GetReferenceDialog("tod_oprole","",System.guid.Empty, id, brief) Then
          txttherole.Tag = id
          txttherole.text = brief
        End If
...
If not txttherole.Tag.Equals(System.Guid.Empty) Then
  item.therole = Item.Application.FindRowObject("tod_oprole",txttherole.Tag)
Else
   item.therole = Nothing
End If
