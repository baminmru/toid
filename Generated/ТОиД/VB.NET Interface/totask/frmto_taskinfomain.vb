...
'''
''' </remarks>
Public Class frmto_taskinfomain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Editto_taskinfo As totaskGUI.editto_taskinfomain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Editto_taskinfo = New totaskGUI.Editto_taskinfomain
        ...
        'Editto_taskinfo
        '
        Me.Editto_taskinfo.AutoScroll = True
        Me.Editto_taskinfo.Location = New System.Drawing.Point(8, 8)
        Me.Editto_taskinfo.name = "Editto_taskinfo"
        Me.Editto_taskinfo.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Editto_taskinfo.TabIndex = 20
        Me.Editto_taskinfo.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmto_taskinfo
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Editto_taskinfo)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmto_taskinfo"
        Me.Text = "Описание"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, totask.totask.to_taskinfo)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Editto_taskinfo.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Editto_taskinfo_Changed() Handles Editto_taskinfo.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If Editto_taskinfo.IsOK() Then
          Editto_taskinfo.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Editto_taskinfo.GetMaxX() + 10, Editto_taskinfo.GetMaxY() + 35)
