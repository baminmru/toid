...
Public Class viewto_scheditemsmain
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.gv.TabIndex = 0
        '
        'viewto_scheditemsmain
        '
        Me.Controls.Add (Me.gv)
        Me.name = "viewto_scheditemsmain"
...
''' </remarks>
    Public Sub Init()
        ...
        Dim dt As DataTable
        dt = item.to_scheditems.GetDataTable()
        dt.TableName = "to_scheditems"

        ts = New DataGridTableStyle
        ts.MappingName = "to_scheditems"
        ts.ReadOnly = True
...
''' </remarks>
    ...
    Exit Sub
        ...
        If ID.Equals(System.guid.Empty) Then
          ...
          Else
              ed = Item.to_scheditems.Add(ID.ToString())
          End If
        Dim gui As Doc_GUIBase
        Dim dt As DataTable
        gui = GuiManager.GetTypeGUI(ed.Application.TypeName)
