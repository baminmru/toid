...
''' <summary>
'''Форма редактирования раздела Описание режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmto_schedinfomain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Editto_schedinfo As toschedGUI.editto_schedinfomain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Editto_schedinfo = New toschedGUI.Editto_schedinfomain
        ...
        'Editto_schedinfo
        '
        Me.Editto_schedinfo.AutoScroll = True
        Me.Editto_schedinfo.Location = New System.Drawing.Point(8, 8)
        Me.Editto_schedinfo.name = "Editto_schedinfo"
        Me.Editto_schedinfo.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Editto_schedinfo.TabIndex = 20
        Me.Editto_schedinfo.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmto_schedinfo
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Editto_schedinfo)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmto_schedinfo"
        Me.Text = "Описание"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tosched.tosched.to_schedinfo)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Editto_schedinfo.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Editto_schedinfo_Changed() Handles Editto_schedinfo.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If Editto_schedinfo.IsOK() Then
          Editto_schedinfo.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Editto_schedinfo.GetMaxX() + 10, Editto_schedinfo.GetMaxY() + 35)
