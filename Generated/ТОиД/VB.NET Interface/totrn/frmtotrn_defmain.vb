...
''' <summary>
'''Форма редактирования раздела Описание тренда режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtotrn_defmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittotrn_def As totrnGUI.edittotrn_defmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittotrn_def = New totrnGUI.Edittotrn_defmain
        ...
        'Edittotrn_def
        '
        Me.Edittotrn_def.AutoScroll = True
        Me.Edittotrn_def.Location = New System.Drawing.Point(8, 8)
        Me.Edittotrn_def.name = "Edittotrn_def"
        Me.Edittotrn_def.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittotrn_def.TabIndex = 20
        Me.Edittotrn_def.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtotrn_def
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittotrn_def)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtotrn_def"
        Me.Text = "Описание тренда"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, totrn.totrn.totrn_def)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittotrn_def.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittotrn_def_Changed() Handles Edittotrn_def.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittotrn_def.GetMaxX() + 10, Edittotrn_def.GetMaxY() + 35)
