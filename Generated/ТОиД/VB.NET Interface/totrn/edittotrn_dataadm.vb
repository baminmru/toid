...
''' <summary>
'''Контрол редактирования раздела Данные тренда режим:adm
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class edittotrn_dataadm
...
private sub dtptime_label_Change(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtptime_label.ValueChanged
  Changing 
        ...
        Private Sub txtthevalue_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtthevalue.Validating
...
Public Sub Save() Implements LATIR2GUIManager.IRowEditor.Save
  ...
  try
    item.time_label = dtptime_label.value
  catch
    item.time_label = System.DateTime.MinValue
  end try
item.thevalue = cdbl(txtthevalue.text)
  end if
  mChanged = false
  raiseevent saved()
end sub
