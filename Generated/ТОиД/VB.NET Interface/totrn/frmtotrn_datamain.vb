...
''' <summary>
'''Форма редактирования раздела Данные тренда режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtotrn_datamain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittotrn_data As totrnGUI.edittotrn_datamain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittotrn_data = New totrnGUI.Edittotrn_datamain
        ...
        'Edittotrn_data
        '
        Me.Edittotrn_data.AutoScroll = True
        Me.Edittotrn_data.Location = New System.Drawing.Point(8, 8)
        Me.Edittotrn_data.name = "Edittotrn_data"
        Me.Edittotrn_data.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittotrn_data.TabIndex = 20
        Me.Edittotrn_data.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtotrn_data
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittotrn_data)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtotrn_data"
        Me.Text = "Данные тренда"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, totrn.totrn.totrn_data)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittotrn_data.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittotrn_data_Changed() Handles Edittotrn_data.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittotrn_data.GetMaxX() + 10, Edittotrn_data.GetMaxY() + 35)
