...
''' </remarks>
    Public Overrides Function ShowPartEditForm(ByVal Mode As String, ByRef RowItem As LATIR2.Document.DocRow_Base, optional byval FormReadOnly as boolean = false) As Boolean
        ...
        If Mode = "" Then
            ...
            If RowItem.PartName.ToUpper = "TOIMG_DEF" Then
                Dim f As frmtoimg_def
                f = New frmtoimg_def
            ...
            If RowItem.PartName.ToUpper = "TOIMG_DATA" Then
                Dim f As frmtoimg_data
                f = New frmtoimg_data
                f.Attach(RowItem, Me.GUIManager,FormReadOnly)
                ShowPartEditForm = (f.ShowDialog() = System.Windows.Forms.DialogResult.OK)
                f = Nothing
            ...
            If RowItem.PartName.ToUpper = "TOIMG_TODELETE" Then
                Dim f As frmtoimg_todelete
                f = New frmtoimg_todelete
                f.Attach(RowItem, Me.GUIManager,FormReadOnly)
                ShowPartEditForm = (f.ShowDialog() = System.Windows.Forms.DialogResult.OK)
                f = Nothing
            End If
