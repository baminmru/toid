...
''' <summary>
'''Форма редактирования раздела Описание хранилища режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtoimg_def
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittoimg_def As toimgGUI.edittoimg_def
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittoimg_def = New toimgGUI.Edittoimg_def
        ...
        'Edittoimg_def
        '
        Me.Edittoimg_def.AutoScroll = True
        Me.Edittoimg_def.Location = New System.Drawing.Point(8, 8)
        Me.Edittoimg_def.name = "Edittoimg_def"
        Me.Edittoimg_def.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittoimg_def.TabIndex = 20
        Me.Edittoimg_def.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtoimg_def
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittoimg_def)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtoimg_def"
        Me.Text = "Описание хранилища"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, toimg.toimg.toimg_def)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittoimg_def.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittoimg_def_Changed() Handles Edittoimg_def.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittoimg_def.GetMaxX() + 10, Edittoimg_def.GetMaxY() + 35)
