...
''' <summary>
'''Форма редактирования раздела Картинки режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmtoimg_data
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Edittoimg_data As toimgGUI.edittoimg_data
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Edittoimg_data = New toimgGUI.Edittoimg_data
        ...
        'Edittoimg_data
        '
        Me.Edittoimg_data.AutoScroll = True
        Me.Edittoimg_data.Location = New System.Drawing.Point(8, 8)
        Me.Edittoimg_data.name = "Edittoimg_data"
        Me.Edittoimg_data.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Edittoimg_data.TabIndex = 20
        Me.Edittoimg_data.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmtoimg_data
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Edittoimg_data)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmtoimg_data"
        Me.Text = "Картинки"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, toimg.toimg.toimg_data)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Edittoimg_data.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Edittoimg_data_Changed() Handles Edittoimg_data.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Edittoimg_data.GetMaxX() + 10, Edittoimg_data.GetMaxY() + 35)
