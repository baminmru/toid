...
''' <summary>
'''Форма редактирования раздела Проверки режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmto_cardchecksmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Editto_cardchecks As tocardGUI.editto_cardchecksmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Editto_cardchecks = New tocardGUI.Editto_cardchecksmain
        ...
        'Editto_cardchecks
        '
        Me.Editto_cardchecks.AutoScroll = True
        Me.Editto_cardchecks.Location = New System.Drawing.Point(8, 8)
        Me.Editto_cardchecks.name = "Editto_cardchecks"
        Me.Editto_cardchecks.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Editto_cardchecks.TabIndex = 20
        Me.Editto_cardchecks.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmto_cardchecks
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Editto_cardchecks)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmto_cardchecks"
        Me.Text = "Проверки"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tocard.tocard.to_cardchecks)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Editto_cardchecks.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Editto_cardchecks_Changed() Handles Editto_cardchecks.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If Editto_cardchecks.IsOK() Then
          Editto_cardchecks.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Editto_cardchecks.GetMaxX() + 10, Editto_cardchecks.GetMaxY() + 35)
