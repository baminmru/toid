...
''' <summary>
'''Форма редактирования раздела Инструменты и материалы режим:main
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmto_carddevicesmain
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Editto_carddevices As tocardGUI.editto_carddevicesmain
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Editto_carddevices = New tocardGUI.Editto_carddevicesmain
        ...
        'Editto_carddevices
        '
        Me.Editto_carddevices.AutoScroll = True
        Me.Editto_carddevices.Location = New System.Drawing.Point(8, 8)
        Me.Editto_carddevices.name = "Editto_carddevices"
        Me.Editto_carddevices.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Editto_carddevices.TabIndex = 20
        Me.Editto_carddevices.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmto_carddevices
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Editto_carddevices)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmto_carddevices"
        Me.Text = "Инструменты и материалы"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, tocard.tocard.to_carddevices)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Editto_carddevices.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Editto_carddevices_Changed() Handles Editto_carddevices.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If Editto_carddevices.IsOK() Then
          Editto_carddevices.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Editto_carddevices.GetMaxX() + 10, Editto_carddevices.GetMaxY() + 35)
