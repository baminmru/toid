...
''' <summary>
'''Реализация строки раздела Роль
''' </summary>
''' <remarks>
'''
''' </remarks>
    Public Class tod_oprole
        Inherits LATIR2.Document.DocRow_Base



''' <summary>
'''Локальная переменная для поля Режим документов
''' </summary>
''' <remarks>
'''
''' </remarks>
...
''' </remarks>
        Public Overrides Sub Unpack(ByVal reader As System.Data.DataRow)
          ...
          If reader.Table.Columns.Contains("docmode") Then m_docmode=reader.item("docmode").ToString()
           catch ex as System.Exception
              Debug.Print( ex.Message + " >> " + ex.StackTrace)
          end try
        End Sub
...
''' <summary>
'''Доступ к полю Режим документов
''' </summary>
''' <remarks>
'''
''' </remarks>
