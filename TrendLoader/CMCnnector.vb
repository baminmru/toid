...
Public Class CMConnector
    ...
    Public toid_site As String = ""
    Public toid_usr As String = ""
    Public toid_pwd As String = ""
    Public ms_site As String = ""
    Public ms_usr As String = ""
    Public ms_pwd As String = ""
    Public ms_base As String = ""
    ...
    Public Function Init() As Boolean
        ...
        nl = xml.GetElementsByTagName("cmconfig")
        node = nl.Item(0)
        ...
        toid_site = node.Attributes.GetNamedItem("toid_site").Value
        toid_usr = node.Attributes.GetNamedItem("toid_usr").Value
        toid_pwd = node.Attributes.GetNamedItem("toid_pwd").Value


        ms_site = node.Attributes.GetNamedItem("MSDataSource").Value
        ms_usr = node.Attributes.GetNamedItem("MsUserID").Value
        ms_pwd = node.Attributes.GetNamedItem("MsPassword").Value
        ms_base = node.Attributes.GetNamedItem("MsBase").Value
